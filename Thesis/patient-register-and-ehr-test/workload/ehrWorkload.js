...
class EHRCreationWorkload extends WorkloadModuleBase {
    constructor() {
        ...
        this.txIndex = 0;
        this.workerIndex = 0;
        this.baseNid = 5000000001; // Match patient registration
    }
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        this.assets = roundArguments.assets || 150; // Default to 50 EHRs
    }
    ...
    async submitTransaction() {
        ...
        // Generate patient hash using getHashgit push -u origin main
        ...
        // Debug log
        console.log('Submitting EHR creation with args:', {
            ehrId: ehrId,
